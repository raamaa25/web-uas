                ...
                <div class="card-body">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('daftar-produk/update-produk/' . $data_produk->id_produk); ?>" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                                <?= csrf_field(); ?>
                                ...
                                <div class="mb3">
                                    ...
                                    <textarea name="deskripsi" id="deskripsi" cols="30" rows="10" class="form-control <?= $validation->hasError('deskripsi') ? 'is-invalid' : null  ?>" required><?= old('deskripsi', $data_produk->deskripsi) ?></textarea>
                                ...
                                <div class="mb3">
                                    ...
                                    <img src="<?= base_url('asset-admin/img/' . $data_produk->gambar_produk) ?>" alt="" class="preview-img mt-2" width="100px">
                                </div>

                                <div class="justify-content-end d-flex">
                                    <button class="btn btn-primary btn-sm mt-4">Ubah</button>
                                </div>
...
<script>
    ...
    function validateForm() {
        const gambar = document.querySelector('#gambar_produk');
        if (gambar.files[0].size > 5 * 1024 * 1024) {
