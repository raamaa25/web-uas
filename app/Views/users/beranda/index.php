        ...
        if ($result) {
          ...
          if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                  ...
                  $judulSlider = $row['judul_slider'];
                  $deskripsiSlider = $row['deskripsi'];
      ?>
                  <!-- Slider -->
                  <div class="carousel-item active" style="background-image: url(<?= base_url('asset-admin/img/' . $gambar_Slider) ?>">
                    <div class="carousel-container">
                      <div class="carousel-content">
                        <h2 class="animate_animated animate_fadeInDown"><?php echo $judulSlider ?> <span>Shuffle</span></h2>
                        <p class="animate_animated animate_fadeInUp">Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut et est quaerat sequi nihil ut aliquam. Occaecati alias dolorem mollitia ut. Similique ea voluptatem. Esse doloremque accusamus repellendus deleniti vel. Minus et tempore modi architecto.</p>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                ...
                <a href="<?= base_url('/portfolio-details.php'); ?>" title="More Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
